...
public class ModBlocks {
    public static final Block ENDERITE_ORE = registerBlock("enderite_ore", 
        new Block(AbstractBlock.Settings.copy(Blocks.ANCIENT_DEBRIS)), Rarity.UNCOMMON);
    public static final Block ARAGONITE_ORE = registerBlock("aragonite_ore", 
        new Block(AbstractBlock.Settings.copy(Blocks.ANCIENT_DEBRIS)), Rarity.RARE);
    public static final Block INFERNITE_ORE = registerBlock("infernite_ore", 
        new Block(AbstractBlock.Settings.copy(Blocks.ANCIENT_DEBRIS)), Rarity.EPIC);

    public static final Block DRILL_UPGRADE_STATION = registerBlock("drill_upgrade_station", 
        new DrillUpgradeStationBlock(AbstractBlock.Settings.copy(Blocks.SMITHING_TABLE).nonOpaque()), Rarity.COMMON);
