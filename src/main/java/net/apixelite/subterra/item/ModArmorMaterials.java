...
public class ModArmorMaterials {
    ...
    public static final ArmorMaterial ENDERITE_ARMOR_MATERIAL = new ArmorMaterial(25, Util.make(new EnumMap<>(EquipmentType.class), map -> {
                ...
                }), 25, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 8, 0.3f, ModTags.Items.ENDERITE_REPAIR, ModEquipmentKeys.ENDERITE);
    ...
    public static final ArmorMaterial ARAGONITE_ARMOR_MATERIAL = new ArmorMaterial(35, Util.make(new EnumMap<>(EquipmentType.class), map -> {
                ...
                }), 25, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 15, 0.7f, ModTags.Items.ARAGONITE_REPAIR, ModEquipmentKeys.ARAGONITE);
    ...
    public static final ArmorMaterial INFERNITE_ARMOR_MATERIAL = new ArmorMaterial(52, Util.make(new EnumMap<>(EquipmentType.class), map -> {
                ...
                }), 25, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 22, 1.0f, ModTags.Items.INFERNITE_REPAIR, ModEquipmentKeys.INFERNITE);

    static RegistryKey<EquipmentAsset> register(String name) {
        return RegistryKey.of(RegistryKey.ofRegistry(Identifier.ofVanilla("equipment_asset")), Identifier.of(Subterra.MOD_ID, name));
    }
}